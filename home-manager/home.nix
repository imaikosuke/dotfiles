...

{
  ...
  home.packages = with pkgs; [
    ...
    # # overrides. Just don't forget the parentheses. Maybe you want to install
    # # Nerd Fonts with a limited number of fonts?
  ...
  # or
  #
  #  /etc/profiles/per-user/imai/etc/profile.d/hm-session-vars.sh
  #
